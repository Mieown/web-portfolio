    ...
    <div className="About">
      <div className="Text-container-about">
        ...
        <p className="About-textinfo">
          ...
          intermediate knowledge of PHP and MySQL. I have worked with a number
          of high profile clients (both directly and indirectly) and I am
          comfortable working under pressure to complex specifications. I
          regularly use version control systems (GIT, Mercurial) to maintain my
          code, and I specialise in responsive web design (RWD). My preferred
          CMS is WordPress, and I am comfortable building bespoke themes from
          the ground up. I have also written a couple of relatively simple
          jQuery plugins
        </p>
      </div>
    </div>
